...
# delete me later
@onready var pallina : Sprite2D = $"Test Pallina/Pallina"
...
func _process(delta: float) -> void:
	...
	if more_rot:
		rotation += rotation_speed * delta * 3
	pass
...
func _on_marker_temporaneo_area_entered(area: Area2D) -> void:
	if area.name == "Test Pallina":
		print("Entrata")
		is_inside_marker = true
	pass # Replace with function body.

func _on_marker_temporaneo_area_exited(area: Area2D) -> void:
	if area.name == "Test Pallina":
		print("Uscita")
